...
<textarea rows="6" cols="39" placeholder="Enter your shipping address" ></textarea> 
<br><br>
<table><tr>
<td><h2>Credit Card:</h2></td></tr>
<tr><td><h2>Card No:</h2></td><td><input type="text" placeholder="Enter Your Card No." size="16" name="ct" required/></td></tr>
<tr><td><h2>Name On Card:</h2></td><td><input type="text" placeholder="Enter Your Card Name." name="cn" required/></td></tr>
<tr><td><h2>Expiry Date:</h2></td></tr>
<tr><td><h2>Month</h2></td><td><input type="text" placeholder="xx" name="cm" required/>
<td><h2>Year</h2></td><td><input type="text" placeholder="xxxx" name="cy" required/></td></tr></table>
<input type="submit" value="Pay" id="btn"/>
</form>
</div>
<div id="im"><img src="pay1.png"/></div>
<div id="l">
<?php
	session_start();
